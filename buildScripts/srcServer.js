...
app.get('/', function(req, res) { //Tell express which routes to handle. Any references to route should handle this function. We are expecting a request and a response
